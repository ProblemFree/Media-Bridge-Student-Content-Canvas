...
import { getFirestore, collection, addDoc, getDocs, query, where, updateDoc, deleteDoc, doc, onSnapshot } from "firebase/firestore";
...
export { storage, db, collection, addDoc, getDocs, query, where, updateDoc, deleteDoc, doc, onSnapshot };
